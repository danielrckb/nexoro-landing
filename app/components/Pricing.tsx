...
const tiers = [
  {
    ...
    features: ['Alle Kernfunktionen von Nexoro inklusive', 'Vollständige Auftragsverwaltung & Kommunikation', 'White-Label Branding', 'Support & Updates inklusive'],
    featured: false,
  },
  {
    name: 'Enterprise',
    ...
    features: [
      'Alle Funktionen des Starter-Pakets inklusive',
      'Individuelle Workflows & eigene Prozessabbildung',
      'Custom Features & Erweiterungen nach Bedarf',
